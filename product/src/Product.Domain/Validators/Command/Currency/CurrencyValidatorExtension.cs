...
internal static class CurrencyValidatorExtension
{
        ...
        where T : CurrencyCommand
    {
        ...
        {
            return !await configRepository.GetAllCurrencies().AnyAsync(e => e.Name.Equals(value), cancellationToken);
        });
    }
        ...
        where T : CurrencyCommand
    {
        return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
        {
            return !await configRepository.GetAllCurrencies().AnyAsync(e => !e.Id.Equals(context.Id.Value) && e.Name.Equals(value), cancellationToken);
        });
    }
        ...
        where T : CurrencyCommand
    {
        return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
        {
            return !await configRepository.GetAllCurrencies().AnyAsync(e => e.Code.Equals(value), cancellationToken);
        });
    }
        ...
        where T : CurrencyCommand
    {
        return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
        {
            return !await configRepository.GetAllCurrencies().AnyAsync(e => !e.Id.Equals(context.Id.Value) && e.Code.Equals(value), cancellationToken);
        });
    }
        ...
        where T : CurrencyCommand
    {
        return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
        {
            return !await configRepository.GetAllCurrencies().AnyAsync(e => e.Symbol.Equals(value), cancellationToken);
        });
    }
        ...
        where T : CurrencyCommand
    {
        return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
        {
            return !await configRepository.GetAllCurrencies().AnyAsync(e => !e.Id.Equals(context.Id.Value) && e.Symbol.Equals(value), cancellationToken);
        });
    }
}