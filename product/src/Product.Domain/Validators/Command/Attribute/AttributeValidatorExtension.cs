...
namespace Product.Domain.Validators
{
    internal static class AttributeValidatorExtension
    {
            ...
            where T : AttributeCommand
        {
            ...
            {
                return !await configRepository.GetAllAttributes().AnyAsync(e => e.Name.Equals(value));
            });
        }
            ...
            where T : AttributeCommand
        {
            return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
            {
                return !await configRepository.GetAllAttributes().AnyAsync(e => !e.Id.Equals(context.Id.Value) && e.Name.Equals(value));
            });
        }
            ...
            where T : AttributeCommand
        {
            return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
            {
                return !await configRepository.GetAllAttributes().AnyAsync(e => e.Unit.Equals(value));
            });
        }
            ...
            where T : AttributeCommand
        {
            return ruleBuilder.MustAsync(async (context, value, cancellationToken) =>
            {
                return !await configRepository.GetAllAttributes().AnyAsync(e => !e.Id.Equals(context.Id.Value) && e.Unit.Equals(value));
            });
        }
    }
}