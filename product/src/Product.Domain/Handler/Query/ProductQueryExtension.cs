...
namespace Product.Domain.Handler.Query
{
    ...
    {
        internal static IQueryable<ProductEntity> WithCriteria(this IQueryable<ProductEntity> products, CriteriaQuery<ProductField> criteriaQuery = null)
        {
        ...
        internal static IQueryable<ProductEntity> WithOrdered(this IQueryable<ProductEntity> products, OrderedQuery<ProductField> orderedQuery = null)
        {
        ...
        internal static IQueryable<ProductEntity> WithPaged(this IQueryable<ProductEntity> products, PagedQuery pagedQuery = null)
        {
            if (pagedQuery == null)
                return products;
