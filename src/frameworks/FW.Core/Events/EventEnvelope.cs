...
public record EventMetadata(string EventId, ulong StreamPosition, ulong LogPosition, TraceMetadata? Trace);
...
public record EventEnvelope<T>(T Data, EventMetadata Metadata) : IEventEnvelope where T : notnull
{
